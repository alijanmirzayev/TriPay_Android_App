package com.alijan.tripay.ui.addcash.transactionaddauth
...
import com.alijan.tripay.databinding.FragmentTransactionAddAuthBinding
...
@AndroidEntryPoint
class TransactionAddAuthFragment : BaseFragment<FragmentTransactionAddAuthBinding>() {
    private val args: TransactionAddAuthFragmentArgs by navArgs()
    private val viewModel by viewModels<TransactionAddAuthViewModel>()
    private val pinNumberAdapter = PinNumberAdapter()
    private val numberList = arrayListOf("1", "2", "3", "4", "5", "6", "7", "8", "9", "", "0", "✖")
    private var pinCode = ""

    override fun layoutInflater(): FragmentTransactionAddAuthBinding =
        FragmentTransactionAddAuthBinding.inflate(layoutInflater)
                ...
                if (pinCode.length == 4 && pinCode == viewModel.pinCode.value?.userPinCode ?: null) {
                    ...
                    lifecycleScope.launch {
                        ...
                        findNavController().navigate(
                            TransactionAddAuthFragmentDirections.actionTransactionAddAuthFragmentToResponseMessageAddFragment(
                                args.amount,
